...
|**Coverage**|[![Build Status](http://dotnet-ci.cloudapp.net/job/dotnet_coreclr_coverage_linux/badge/icon)](http://dotnet-ci.cloudapp.net/job/dotnet_coreclr_coverage_linux/CoreCLR_Code_Coverage_Report/) |
