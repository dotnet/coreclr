...
if(CMAKE_SYSTEM_NAME STREQUAL Linux)
    ...
    if(CLR_CROSS_COMPONENTS_BUILD)
        ...
        if(CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL x86_64 OR CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL amd64)
            if(CLR_CMAKE_TARGET_ARCH STREQUAL "arm" OR CLR_CMAKE_TARGET_ARCH STREQUAL "armel" OR CLR_CMAKE_TARGET_ARCH STREQUAL "armv6")
        ...
        elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL armv6)
            set(CLR_CMAKE_PLATFORM_UNIX_ARMV6 1)
...
elseif(CLR_CMAKE_PLATFORM_UNIX_ARMV6)
    set(CLR_CMAKE_PLATFORM_ARCH_ARMV6 1)
...
elseif(WIN32)
    ...
    elseif(CLR_CMAKE_HOST_ARCH STREQUAL arm)
        set(CLR_CMAKE_PLATFORM_ARCH_ARM 1)
    elseif(CLR_CMAKE_HOST_ARCH STREQUAL armv6)
        set(CLR_CMAKE_PLATFORM_ARCH_ARMV6 1)
...
if(NOT(CLR_CMAKE_TARGET_ARCH STREQUAL CLR_CMAKE_HOST_ARCH))
    if(NOT((CLR_CMAKE_PLATFORM_ARCH_AMD64 AND CLR_CMAKE_TARGET_ARCH_ARM64) OR (CLR_CMAKE_PLATFORM_ARCH_I386 AND CLR_CMAKE_TARGET_ARCH_ARM) OR (CLR_CMAKE_PLATFORM_ARCH_I386 AND CLR_CMAKE_TARGET_ARCH_ARMV6) OR (CLR_CMAKE_PLATFORM_ARCH_AMD64 AND CLR_CMAKE_TARGET_ARCH_ARM) OR (CLR_CMAKE_PLATFORM_ARCH_AMD64 AND CLR_CMAKE_TARGET_ARCH_ARMV6)))
...
elseif (CLR_CMAKE_PLATFORM_ARCH_ARMV6)
  add_definitions(-D_ARMV6_)
  add_definitions(-DARMV6)
  add_definitions(-D_ARM_)
  add_definitions(-DARM)
elseif (CLR_CMAKE_PLATFORM_ARCH_ARM64)
