...
if (CLR_CMAKE_TARGET_OS STREQUAL CLR_CMAKE_PLATFORM_OS)
    ...
    if(NOT (CLR_CMAKE_PLATFORM_OS STREQUAL Windows_NT))
        message(FATAL_ERROR "Invalid host and target os/arch combination. Host OS: ${CLR_CMAKE_PLATFORM_OS}")
    endif()
    ...
    if(NOT ((CLR_CMAKE_PLATFORM_ARCH_AMD64 AND (CLR_CMAKE_TARGET_ARCH_AMD64 OR CLR_CMAKE_TARGET_ARCH_ARM64)) OR (CLR_CMAKE_PLATFORM_ARCH_I386 AND CLR_CMAKE_TARGET_ARCH_ARM)))
