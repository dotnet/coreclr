...
if(CMAKE_CXX_COMPILER_VERSION MATCHES "^([0-9]+).([0-9]+)")
  set(CLR_CMAKE_COMPILER_TOOL_MAJOR_VERSION "${CMAKE_MATCH_1}")
  set(CLR_CMAKE_COMPILER_TOOL_MINOR_VERSION "${CMAKE_MATCH_2}")
else()
  set(CLR_CMAKE_COMPILER_TOOL_MAJOR_VERSION ${CMAKE_CXX_COMPILER_VERSION})
endif()
...
if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  ...
  function(locate_llvm_exec exec var)
    find_program(EXEC_LOCATION
     NAMES
      "${LLVM_PREFIX}${exec}-${CLR_CMAKE_COMPILER_TOOL_MAJOR_VERSION}.${CLR_CMAKE_COMPILER_TOOL_MINOR_VERSION}"
      "${LLVM_PREFIX}${exec}${CLR_CMAKE_COMPILER_TOOL_MAJOR_VERSION}${CLR_CMAKE_COMPILER_TOOL_MINOR_VERSION}"
      "${LLVM_PREFIX}${exec}-${CLR_CMAKE_COMPILER_TOOL_MAJOR_VERSION}${CLR_CMAKE_COMPILER_TOOL_MINOR_VERSION}"
      "${LLVM_PREFIX}${exec}")
...
elseif(CMAKE_CXX_COMPILER_ID MATCHES "GNU")
  ...
  function(locate_gcc_exec exec var)
    ...
    find_program(EXEC_LOCATION
      NAMES
      "${GCC_PREFIX}${exec}-${CLR_CMAKE_COMPILER_TOOL_MAJOR_VERSION}.${CLR_CMAKE_COMPILER_TOOL_MINOR_VERSION}"
      "${GCC_PREFIX}${exec}${CLR_CMAKE_COMPILER_TOOL_MAJOR_VERSION}${CLR_CMAKE_COMPILER_TOOL_MINOR_VERSION}"
      "${GCC_PREFIX}${exec}-${CLR_CMAKE_COMPILER_TOOL_MAJOR_VERSION}${CLR_CMAKE_COMPILER_TOOL_MINOR_VERSION}"
      "${GCC_PREFIX}${exec}")
    if (EXEC_LOCATION STREQUAL "EXEC_LOCATION-NOTFOUND")
