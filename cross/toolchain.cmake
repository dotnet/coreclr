...
elseif(TARGET_ARCH_NAME STREQUAL "arm")
  set(CMAKE_SYSTEM_PROCESSOR armv7l)
  if(EXISTS ${CMAKE_SYSROOT}/usr/lib/gcc/armv6-alpine-linux-musleabihf)
...
elseif(TARGET_ARCH_NAME STREQUAL "arm64")
  ...
  if(EXISTS ${CMAKE_SYSROOT}/usr/lib/gcc/aarch64-alpine-linux-musl)
...
if(TARGET_ARCH_NAME STREQUAL "armel")
  if(DEFINED TIZEN_TOOLCHAIN)
    include_directories(SYSTEM ${CMAKE_SYSROOT}/usr/lib/gcc/${TIZEN_TOOLCHAIN}/include/c++/)
    include_directories(SYSTEM ${CMAKE_SYSROOT}/usr/lib/gcc/${TIZEN_TOOLCHAIN}/include/c++/armv7l-tizen-linux-gnueabi)
  endif()
endif()
...
# Specify link flags
add_compile_param(CROSS_LINK_FLAGS "--gcc-toolchain=${CMAKE_SYSROOT}/usr")
add_compile_param(CROSS_LINK_FLAGS "-fuse-ld=gold")

if(TARGET_ARCH_NAME STREQUAL "armel")
  if(DEFINED TIZEN_TOOLCHAIN) # For Tizen only
    add_compile_param(CROSS_LINK_FLAGS "-B${CMAKE_SYSROOT}/usr/lib/gcc/${TIZEN_TOOLCHAIN}")
    add_compile_param(CROSS_LINK_FLAGS "-L${CMAKE_SYSROOT}/lib")
    add_compile_param(CROSS_LINK_FLAGS "-L${CMAKE_SYSROOT}/usr/lib")
    add_compile_param(CROSS_LINK_FLAGS "-L${CMAKE_SYSROOT}/usr/lib/gcc/${TIZEN_TOOLCHAIN}")
  endif()
elseif(TARGET_ARCH_NAME STREQUAL "x86")
...
add_compile_options("--gcc-toolchain=${CMAKE_SYSROOT}/usr")
...
if(TARGET_ARCH_NAME MATCHES "^(arm|armel|x86)$")
  ...
  if(LLVM_CROSS_DIR)
    ...
    if(TARGET_ARCH_NAME STREQUAL "x86")
      set(WITH_LLDB_LIBS "${CMAKE_SYSROOT}/usr/lib/i386-linux-gnu" CACHE STRING "")
      set(CHECK_LLVM_DIR "${CMAKE_SYSROOT}/usr/lib/llvm-3.8/include")
      if(EXISTS "${CHECK_LLVM_DIR}" AND IS_DIRECTORY "${CHECK_LLVM_DIR}")
        set(WITH_LLDB_INCLUDES "${CHECK_LLVM_DIR}")
      else()
        set(WITH_LLDB_INCLUDES "${CMAKE_SYSROOT}/usr/lib/llvm-3.6/include")
      endif()
    else() # arm/armel case
      set(WITH_LLDB_LIBS "${CMAKE_SYSROOT}/usr/lib/${TOOLCHAIN}" CACHE STRING "")
      set(WITH_LLDB_INCLUDES "${CMAKE_SYSROOT}/usr/lib/llvm-3.6/include" CACHE STRING "")
    endif()
  endif()
endif()
