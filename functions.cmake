...
function(_add_executable)
    if(NOT WIN32)
      ...
      if (HAVE_LTO AND CLR_CMAKE_BUILD_COREBUNDLE)
        target_compile_options(${ARGV0} PRIVATE -flto)
        set_target_properties(${ARGV0} PROPERTIES LINK_FLAGS "${LINK_FLAGS} -flto ")
      endif()
    else()
      add_executable(${ARGV})
    endif(NOT WIN32)
...
function(_add_library)
    if(NOT WIN32)
      ...
      if (HAVE_LTO AND CLR_CMAKE_BUILD_COREBUNDLE AND ${ARGV1} EQUAL "STATIC")
        target_compile_options(${ARGV0} PRIVATE -flto)
      endif()
    else()
      add_library(${ARGV})
