...
powershell -NoProfile -ExecutionPolicy unrestricted -Command %~dp0dotnet-download.ps1 -DOTNET_REMOTE_PATH %DOTNET_REMOTE_PATH% -DOTNET_LOCAL_PATH %DOTNET_LOCAL_PATH% -DOTNET_PATH %DOTNET_PATH% >> "%INIT_TOOLS_LOG%"
