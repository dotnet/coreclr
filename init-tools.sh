...
if [ ! -e $__BUILD_TOOLS_PATH ]; then
    ...
    $__DOTNET_CMD restore "$__INIT_TOOLS_RESTORE_PROJECT" --no-cache --packages $__PACKAGES_DIR --source $__BUILDTOOLS_SOURCE --source https://karajascli.blob.core.windows.net/buildtools/index.json /p:BuildToolsPackageVersion=$__BUILD_TOOLS_PACKAGE_VERSION >> $__init_tools_log
