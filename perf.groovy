    ...
    ['Windows_NT'].each { os ->
        ['x64', 'x86', 'x86lb', 'x86lb_mo'].each { arch ->
            [true, false].each { isSmoketest ->
                ...
                precommand = 'set TEST_ENV=${testEnv}'
