...
namespace System
{
    public static partial class Convert
    {
        private static unsafe void EncodeBase64Avx(byte* input, int inputLength, byte* output, int outputLength)
        {
            ...
            Vector256<ulong> shiftLut = Vector256.Create(
                18229723555195321415UL, 72503040736508UL,
                18229723555195321415UL, 72503040736508UL);

            Vector256<byte> asciiToStringMask = Vector256.Create((byte)
            ...
            // we can make it ConvertToBase64Array's responsibility too
