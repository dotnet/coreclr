...
namespace System
{
    internal static partial class Number
    {
        ...
        private const int DecimalNumberBufferLength = 29 + 1;  // 29 for the longest input + 1 for rounding
        private const int DoubleNumberBufferLength = 768 + 1;  // 768 for the longest input + 1 for rounding: 4.9406564584124654E-324 
        ...
        private const int SingleNumberBufferLength = 113 + 1;  // 113 for the longest input + 1 for rounding: 1.40129846E-45
