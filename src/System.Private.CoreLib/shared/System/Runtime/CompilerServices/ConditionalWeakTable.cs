...
namespace System.Runtime.CompilerServices
{
        ...
        where TValue : class?
    {
        ...
        public bool TryGetValue(TKey key, [MaybeNullWhen(false)] out TValue value)
        {
            ...
            return _container.TryGetValueWorker(key!, out value); // TODO-NULLABLE: Remove ! when nullable attributes are respected
        }
        ...
        public void Add(TKey key, TValue value)
        {
            ...
            lock (_lock)
            {
                int entryIndex = _container.FindEntry(key!, out _); // TODO-NULLABLE: Remove ! when nullable attributes are respected
                if (entryIndex != -1)
                {
                    ThrowHelper.ThrowArgumentException(ExceptionResource.Argument_AddingDuplicate);
                }

                CreateEntry(key!, value); // TODO-NULLABLE: Remove ! when nullable attributes are respected
            }
        }
        ...
        public bool Remove(TKey key)
        {
            ...
            lock (_lock)
            {
                return _container.Remove(key!); // TODO-NULLABLE: Remove ! when nullable attributes are respected
            }
        }
        ...
        private sealed class Container
        {
            ...
            internal bool TryGetEntry(int index, [MaybeNull, NotNullWhen(true)] out TKey key, [MaybeNullWhen(false)] out TValue value)
            {
