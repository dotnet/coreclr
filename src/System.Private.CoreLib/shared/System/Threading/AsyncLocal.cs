...
namespace System.Threading
{
    ...
    public sealed class AsyncLocal<T> : IAsyncLocal
    {
        ...
        public T Value
        {
            ...
            set
            {
                ExecutionContext.SetLocalValue(this, value, !(m_valueChangedHandler is null));
            }
        }
    ...
    internal static class AsyncLocalValueMap
    {
        ...
        {
            Debug.Assert(!(asyncLocalValueMap is null));
        ...
        public static IAsyncLocalValueMap Create(IAsyncLocal key, object value, bool treatNullValueAsNonexistent)
        {
            ...
            return !(value is null) || !treatNullValueAsNonexistent ?
