    ...
    internal sealed class RuntimeEventSource : EventSource
    {
        ...
        protected override void OnEventCommand(EventCommandEventArgs command)
        {
            if (command.Command == EventCommand.Enable)
            {
                ...
                _assemblyCounter = _assemblyCounter ?? new PollingCounter("assembly-count", this, () => System.Reflection.Assembly.GetCurrentAssemblyCount()) { DisplayName = "Number of Assemblies Loaded" };
            }
        }
    }
}
