...
static const char *SymbolReaderDllName = "System.Diagnostics.StackTrace";
static const char *SymbolReaderClassName = "System.Diagnostics.SymbolReader";

typedef  int (*ReadMemoryDelegate)(ULONG64, char *, int);
typedef  ULONG64 (*LoadSymbolsForModuleDelegate)(const char*, ULONG64, int, ULONG64, int, ReadMemoryDelegate);
...
private:
    ...
    HRESULT LoadSymbolsForWindows(IMetaDataImport* pMD, ULONG64 peAddress, __in_z WCHAR* pModuleName, BOOL isInMemory);
    HRESULT LoadSymbolsForPortablePDB(BOOL isInMemory, __in_z WCHAR* pModuleName, ULONG64 peAddress, ULONG64 peSize, ULONG64 inMemoryPdbAddress, ULONG64 inMemoryPdbSize);
...
public:
    ...
    HRESULT LoadSymbols(IMetaDataImport* pMD, IXCLRDataModule* pModule);
    HRESULT GetLineByILOffset(mdMethodDef MethodToken, ULONG64 IlOffset, ___out ULONG *pLinenum, __out_ecount(cchFileName) WCHAR* pwszFileName, ___in ULONG cchFileName);
    ...
    HRESULT ResolveSequencePoint(__in_z WCHAR* pFilename, ULONG32 lineNumber, TADDR mod, mdMethodDef* pToken, ULONG32* pIlOffset);
};
