...
// File machine generated by Amd64InstructioTableGenerator.Amd64InstructioTableGenerator.WriteCode()

// This file's primary purpose is to provide a reliable mechanism to implement
// Amd64 NativeWalker::DecodeInstructionForPatchSkip(const BYTE *address, InstructionAttribute * pInstrAttrib)
//
// To accomplish that the tables below provide metadata necessary to determine:
//   - Whether the instruction includes a modrm
//   - Whether the modrm is the first and/or only operand
//   - The size of the memory operation in bytes
//   - The number of immediate bytes
//
