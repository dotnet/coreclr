...
namespace Amd64InstructioTableGenerator
{
    ...
    class Amd64InstructioTableGenerator
    {
        ...
        void WriteCode()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("// File machine generated by Amd64InstructioTableGenerator.Amd64InstructioTableGenerator.WriteCode()");
            Console.WriteLine();
            Console.WriteLine("// This file's primary purpose is to provide a reliable mechanism to implement");
            Console.WriteLine("// Amd64 NativeWalker::DecodeInstructionForPatchSkip(const BYTE *address, InstructionAttribute * pInstrAttrib)");
            Console.WriteLine("//");
            Console.WriteLine("// To accomplish that the tables below provide metadata necessary to determine:");
            Console.WriteLine("//   - Whether the instruction includes a modrm");
            Console.WriteLine("//   - Whether the modrm is the first and/or only operand");
            Console.WriteLine("//   - The size of the memory operation in bytes");
            Console.WriteLine("//   - The number of immediate bytes");
            Console.WriteLine("//");
            Console.WriteLine();
            Console.WriteLine();
            ...
            Console.WriteLine("    enum InstrForm");
            Console.WriteLine("    {");
