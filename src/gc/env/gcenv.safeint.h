...
#ifndef __GCENV_SAFEINT_H__
#define __GCENV_SAFEINT_H__
...
typedef ClrSafeInt<uint8_t>  S_UINT8;
typedef ClrSafeInt<uint16_t> S_UINT16;
typedef ClrSafeInt<uint32_t> S_UINT32;
typedef ClrSafeInt<uint64_t> S_UINT64;
typedef ClrSafeInt<size_t>   S_SIZE_T;

#endif //__GCENV_SAFEINT_H__
