...
RETAIL_CONFIG_STRING_INFO(EXTERNAL_NativeImagePerfMapFormat, W("RVA"), "Specifies the format of native image perfmap files generated by crossgen.  Valid options are RVA or OFFSET.")
#endif
