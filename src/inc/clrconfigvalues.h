...
RETAIL_CONFIG_DWORD_INFO_EX(EXTERNAL_CORECLR_DISABLE_REJIT_ON_ATTACH, W("CORECLR_DISABLE_REJIT_ON_ATTACH"), 0, "Disables the ability for profilers to rejit methods on attach.", CLRConfig::DontPrependCOMPlus_)
