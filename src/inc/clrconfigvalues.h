...
RETAIL_CONFIG_DWORD_INFO(UNSUPPORTED_TieredCompilation_PatchVirtualSlots, W("TieredCompilation_PatchVirtualSlots"), 1, "Indicates whether to avoid making virtual calls through a precode and instead to patch virtual slots for a method when its entry point changes.")
