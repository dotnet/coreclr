...
enum CrstType
{
    ...
    CrstAssemblyList = 6,
    CrstAssemblyLoadContextLoaderAllocators = 7,
    CrstAssemblyLoader = 8,
    CrstAssemblyUsageLog = 9,
    CrstAvailableClass = 10,
    CrstAvailableParamTypes = 11,
    CrstBaseDomain = 12,
    CrstCCompRC = 13,
    CrstCer = 14,
    CrstClassFactInfoHash = 15,
    CrstClassInit = 16,
...
int g_rgCrstLevelMap[] =
{
    ...
    0,			// CrstAssemblyList
    16,			// CrstAssemblyLoadContextLoaderAllocators
...
LPCSTR g_rgCrstNameMap[] =
{
    ...
    "CrstAssemblyList",
    "CrstAssemblyLoadContextLoaderAllocators",
    "CrstAssemblyLoader",
