...
// by anyone.
    ...
    JITHELPER(CORINFO_HELP_READYTORUN_STUBHELPERS_INIT_DECLARING_TYPE, StubHelpers::InitDeclaringType, CORINFO_HELP_SIG_REG_ONLY)
    JITHELPER(CORINFO_HELP_READYTORUN_STUBHELPERS_GET_NDIRECT_TARGET, StubHelpers::GetNDirectTarget, CORINFO_HELP_SIG_REG_ONLY)
