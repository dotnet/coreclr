...
HELPER(READYTORUN_HELPER_StubHelpersInitDeclaringType, CORINFO_HELP_READYTORUN_STUBHELPERS_INIT_DECLARING_TYPE, )
HELPER(READYTORUN_HELPER_StubHelpersGetNDirectTarget, CORINFO_HELP_READYTORUN_STUBHELPERS_GET_NDIRECT_TARGET, )
