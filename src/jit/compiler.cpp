...
// getEightByteType:
//   Returns the type of the struct descrition and slot number of the eightbyte.
//
// args:
//   structDesc: struct classification description.
//   slotNum: eightbyte slot number for the struct.
//   
var_types Compiler::getEightByteType(SYSTEMV_AMD64_CORINFO_STRUCT_REG_PASSING_DESCRIPTOR structDesc, unsigned slotNum)
{
