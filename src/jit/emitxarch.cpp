...
bool emitter::IsThreeOperandBinaryAVXInstruction(instruction ins)
{
    return IsAVXInstruction(ins) &&
           (ins == INS_cvtsi2ss || ins == INS_cvtsi2sd || ins == INS_cvtss2sd || ins == INS_cvtsd2ss ||
            ...
            ins == INS_vinsertf128 || ins == INS_vinserti128 || ins == INS_phaddd || ins == INS_punpckhbw ||
            ins == INS_punpcklbw || ins == INS_punpckhqdq || ins == INS_punpcklqdq || ins == INS_punpckhwd ||
            ins == INS_punpcklwd || ins == INS_punpckhdq || ins == INS_punpckldq || ins == INS_packssdw ||
...
bool emitter::Is4ByteAVXInstruction(instruction ins)
{
    return UseAVX() &&
           (ins == INS_dpps || ins == INS_dppd || ins == INS_insertps || ins == INS_pcmpeqq || ins == INS_pcmpgtq ||
            ...
            ins == INS_vinsertf128 || ins == INS_vinserti128 || ins == INS_pmulld || ins == INS_ptest ||
            ins == INS_phaddd);
}
#endif // FEATURE_AVX_SUPPORT
...
size_t emitter::emitOutputInstr(insGroup* ig, instrDesc* id, BYTE** dp)
{
    ...
    switch (id->idInsFmt())
    {
        ...
        case IF_RRW_RRW_CNS:
            ...
            // TODO find a good place to set w1 bit
            if (ins == INS_vpermq)
            {
                code |= 0x00008000000000ULL;
            }
