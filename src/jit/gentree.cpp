...
// clang-format off
    ...
    GenTree::s_gtNodeSizes[GT_RET_EXPR]         = TREE_NODE_SZ_LARGE; // Can be bashed to GT_CALL.
    ...
    static_assert_no_msg(sizeof(GenTreeArrElem)      <= TREE_NODE_SZ_LARGE);
    ...
    static_assert_no_msg(sizeof(GenTreeStmt)         <= TREE_NODE_SZ_SMALL);
