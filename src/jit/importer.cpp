...
{
    GenTreeStmt* stmtPrev = stmtBefore->gtPrevStmt;
                                    ...
                                    bool                 willDeref)
{
    ...
    else if (oper == GT_COMMA)
    {
        ...
        if (oldLastStmt != impTreeLast)
        {
            ...
            impInsertTreeBefore(structVal->gtOp.gtOp1, impCurStmtOffs, oldLastStmt->gtNextStmt);
...
void Compiler::impImportLeave(BasicBlock* block)
{
    ...
    for (XTnum = 0, HBtab = compHndBBtab; XTnum < compHndBBtabCount; XTnum++, HBtab++)
    {
                 ...
                 !jitIsBetween(jmpAddr, tryBeg, tryEnd))
        {
            ...
            assert(!encFinallies ==
                   !endLFinStmt); // if we have finallies, we better have an endLFinStmt, and vice-versa
            ...
            endLFinStmt           = gtNewStmt(endLFinStmt);
            endCatches            = NULL;
