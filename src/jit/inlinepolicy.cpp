...
RandomPolicy::RandomPolicy(Compiler* compiler, bool isPrejitRoot, unsigned seed)
    : LegalPolicy(isPrejitRoot), m_RootCompiler(compiler), m_Random(nullptr), m_CodeSize(0), m_IsForceInline(false),
...
ReplayPolicy::ReplayPolicy(Compiler* compiler, bool isPrejitRoot)
    : DiscretionaryPolicy(compiler, isPrejitRoot), m_InlineContext(nullptr), m_Offset(BAD_IL_OFFSET),
