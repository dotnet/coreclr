...
private:
    ...
    // be allocated a busy register by spilling another less important RefPosition.
    enum LsraRegOptionalControl     { LSRA_REG_OPTIONAL_DEFAULT          = 0,
                                      LSRA_REG_OPTIONAL_NO_BUSYREG_ALLOC = 0x1000,
    ...
    bool                        regOptionalNoBusyRegAlloc()     
    { 
        //return getLsraRegOptionalControl() == LSRA_REG_OPTIONAL_NO_BUSYREG_ALLOC;
        return true;
    }
