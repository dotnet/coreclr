...
{
    bool areEquals = vlType == rhs->vlType;
    ...
    if (areEquals)
    {
        switch (vlType)
        {
            case VLT_STK:
            case VLT_STK_BYREF:
                areEquals = vlStk.vlsBaseReg == rhs->vlStk.vlsBaseReg;
                areEquals &= vlStk.vlsOffset == rhs->vlStk.vlsOffset;
                break;

            case VLT_STK2:
                areEquals = vlStk2.vls2BaseReg == rhs->vlStk2.vls2BaseReg;
                areEquals &= vlStk2.vls2Offset == rhs->vlStk2.vls2Offset;
                break;

            case VLT_REG:
            case VLT_REG_FP:
            case VLT_REG_BYREF:
                areEquals = vlReg.vlrReg == rhs->vlReg.vlrReg;
                break;

            case VLT_REG_REG:
                areEquals = vlRegReg.vlrrReg1 == rhs->vlRegReg.vlrrReg1;
                areEquals &= vlRegReg.vlrrReg2 == rhs->vlRegReg.vlrrReg2;
                break;

            case VLT_REG_STK:
                areEquals = vlRegStk.vlrsReg == rhs->vlRegStk.vlrsReg;
                areEquals &= vlRegStk.vlrsStk.vlrssBaseReg == rhs->vlRegStk.vlrsStk.vlrssBaseReg;
                areEquals &= vlRegStk.vlrsStk.vlrssOffset == rhs->vlRegStk.vlrsStk.vlrssOffset;
                break;

            case VLT_STK_REG:
                areEquals = vlStkReg.vlsrReg == rhs->vlStkReg.vlsrReg;
                areEquals &= vlStkReg.vlsrStk.vlsrsBaseReg == rhs->vlStkReg.vlsrStk.vlsrsBaseReg;
                areEquals &= vlStkReg.vlsrStk.vlsrsOffset == rhs->vlStkReg.vlsrStk.vlsrsOffset;
                break;

            case VLT_FPSTK:
                areEquals = vlFPstk.vlfReg == rhs->vlFPstk.vlfReg;
                break;

            case VLT_FIXED_VA:
                areEquals = vlFixedVarArg.vlfvOffset == rhs->vlFixedVarArg.vlfvOffset;
                break;
