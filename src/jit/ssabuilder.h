...
private:
    ...
    // Rename a SSA definition generated by an assignment node
    void RenameDef(GenTreeOp* asgNode, BasicBlock* block, SsaRenameState* pRenameState);
    // Rename a SSA use of a local variable
    void RenameUse(GenTreeLclVarCommon* lclNode, BasicBlock* block, SsaRenameState* pRenameState);
