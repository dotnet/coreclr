...
#define CPBLK_MOVS_LIMIT         16      // When generating code for CpBlk, this is the buffer size 
  ...
  #define MAX_MULTIREG_ARGS             2  // Maximum number of args that can be passed in registers 
...
*/
  ...
  #define MAX_MULTIREG_ARGS             4  // Maximum number of args that can be passed in registers (max is 4 floats or doubles using an HFA)
