...
ValueNumStore::ValueNumStore(Compiler* comp, IAllocator* alloc)
    : m_pComp(comp), m_alloc(alloc),
      ...
      m_numMapSels(0),
#endif
      m_nextChunkBase(0), m_fixedPointMapSels(alloc, 8), m_chunks(alloc, 8), m_intCnsMap(nullptr),
      m_longCnsMap(nullptr), m_handleMap(nullptr), m_floatCnsMap(nullptr), m_doubleCnsMap(nullptr),
      m_byrefCnsMap(nullptr), m_VNFunc0Map(nullptr), m_VNFunc1Map(nullptr), m_VNFunc2Map(nullptr),
      m_VNFunc3Map(nullptr), m_VNFunc4Map(nullptr), m_uPtrToLocNotAFieldCount(1)
{
...
struct ValueNumberState
{
    ...
    ValueNumberState(Compiler* comp)
        : m_toDoAllPredsDone(comp->getAllocator(), /*minSize*/ 4),
          m_toDoNotAllPredsDone(comp->getAllocator(), /*minSize*/ 4), m_comp(comp),
