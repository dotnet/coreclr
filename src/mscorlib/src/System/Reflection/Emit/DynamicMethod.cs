    ...
    public sealed class DynamicMethod : MethodInfo
    {
        ...
        public override Object Invoke(Object obj, BindingFlags invokeAttr, Binder binder, Object[] parameters, CultureInfo culture)
        {
            ...
            if (actualCount > 0)
            {
                ...
                retValue = RuntimeMethodHandle.InvokeMethod(null, arguments, sig, false, doNotWrapExceptions);
            ...
            {
                retValue = RuntimeMethodHandle.InvokeMethod(null, null, sig, false, doNotWrapExceptions);
            }
