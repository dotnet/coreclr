...
enum __MIDL___MIDL_itf_corprof_0000_0000_0006
    {
        ...
        COR_PRF_HIGH_MONITOR_EVENT_PIPE	= 0x10,
        COR_PRF_HIGH_REQUIRE_PROFILE_IMAGE	= 0,
        COR_PRF_HIGH_ALLOWABLE_AFTER_ATTACH	= ( ( COR_PRF_HIGH_IN_MEMORY_SYMBOLS_UPDATED | COR_PRF_HIGH_MONITOR_DYNAMIC_FUNCTION_UNLOADS )  | COR_PRF_HIGH_MONITOR_EVENT_PIPE ) ,
...
#define ICorProfilerCallback10_EventPipeEventDelivered(This,eventName,eventId,eventVersion,cbMetadataBlob,metadataBlob,eventThreadId,eventTimestamp,cbEventData,eventData,numStackFrames,stackFrames)	\
    ( (This)->lpVtbl -> EventPipeEventDelivered(This,eventName,eventId,eventVersion,cbMetadataBlob,metadataBlob,eventThreadId,eventTimestamp,cbEventData,eventData,numStackFrames,stackFrames) ) 
