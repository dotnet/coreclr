...
ErrorString palErrorStrings[] =
{
    ...
    { ERROR_NOT_ENOUGH_MEMORY, W("Not enough memory is available to process this command.\n") },
    ...
    { ERROR_OUTOFMEMORY, W("Not enough memory is available to complete this operation.\n") },
