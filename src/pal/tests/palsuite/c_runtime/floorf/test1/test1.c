...
int __cdecl main(int argc, char *argv[])
{
    struct test tests[] = 
    {
        ...
        {  0.318309886f,    0,           0.000001f },   // value:  1 / pi
        {  0.434294482f,    0,           0.000001f },   // value:  log10(e)
        {  0.636619772f,    0,           0.000001f },   // value:  2 / pi
        {  0.693147181f,    0,           0.000001f },   // value:  ln(2)
        {  0.707106781f,    0,           0.000001f },   // value:  1 / sqrt(2)
        {  0.785398163f,    0,           0.000001f },   // value:  pi / 4
        {  1.12837917f,     1,           0.00001f },   // value:  2 / sqrt(pi)
        {  1.41421356f,     1,           0.00001f },   // value:  sqrt(2)
        {  1.44269504f,     1,           0.00001f },   // value:  log2(e)
        {  1.57079633f,     1,           0.00001f },   // value:  pi / 2
        {  2.30258509f,     2,           0.00001f },   // value:  ln(10)
        {  2.71828183f,     2,           0.00001f },   // value:  e
        {  3.14159265f,     3,           0.00001f },   // value:  pi
		{  INFINITY,        INFINITY,    0 }
    };
