...
namespace Internal.TypeSystem
{
    ...
    {
        /// <summary>
        /// Gets an identifier that is the same for all instances of this <see cref="ModuleDesc"/>
        ...
        protected internal abstract int CompareToImpl(ModuleDesc other, TypeSystemComparer comparer);
    }
}
