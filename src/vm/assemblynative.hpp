...
public:
    ...
    static INT_PTR QCALLTYPE InitializeAssemblyLoadContext(INT_PTR ptrManagedAssemblyLoadContext, QCall::ObjectHandleOnStack pAssemblyName, QCall::ObjectHandleOnStack retDummyAssembly);
