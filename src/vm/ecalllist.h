...
FCFuncStart(gRuntimeHelpers)
    ...
    FCFuncElement("AllocTailCallArgBuffer", StubHelpers::AllocTailCallArgBuffer)
    FCFuncElement("GetTailCallArgBuffer", StubHelpers::GetTailCallArgBuffer)
    FCFuncElement("FreeTailCallArgBuffer", StubHelpers::FreeTailCallArgBuffer)
FCFuncEnd()
