...
FCFuncStart(gRuntimeHelpers)
    ...
    FCFuncElement("PushNewTailCallFrame", TailCallHelp::PushNewTailCallFrame)
    FCFuncElement("PopTailCallFrame", TailCallHelp::PopTailCallFrame)
    FCFuncElement("TailCallHelper", JIT_NewTailCallHelper)
FCFuncEnd()
