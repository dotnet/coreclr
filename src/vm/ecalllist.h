...
FCFuncStart(gGCInterfaceFuncs)
    ...
    FCFuncElement("GetPercentTimeInGC", GCInterface::GetPercentTimeInGC)
    FCFuncElement("GetGenerationSize", GCInterface::GetGenerationSize)
    FCFuncElement("GetLOHSize", GCInterface::GetLOHSize)
    FCFuncElement("GetTotalAllocation", GCInterface::GetTotalAllocation)
