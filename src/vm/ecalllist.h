...
FCFuncStart(gHighPerformanceCounterFuncs)
    FCFuncElement("QueryPerformanceFrequency", SystemNative::QueryPerformanceFrequency)
    FCFuncElement("QueryPerformanceCounter", SystemNative::QueryPerformanceCounter)
FCFuncEnd()
...
FCClassElement("HighPerformanceCounter", "System", gHighPerformanceCounterFuncs)
#ifdef FEATURE_COMINTEROP
