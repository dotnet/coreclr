...
public:
    ...
    bool          TieredCompilation_PatchVirtualSlots() const { LIMITED_METHOD_CONTRACT; return tieredCompilation_patchVirtualSlots; }
#endif
...
#define DEFAULT_GC_PRN_LVL 3
    ...
    bool tieredCompilation_patchVirtualSlots;
#endif
