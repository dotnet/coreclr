...
EventPipeStream::EventPipeStream(IpcStream *pStream) : FastSerializableObject(3, 0)
{
    CONTRACTL
    {
        THROWS;
    ...
    m_pSerializer = new FastSerializer(new IpcStreamWriter(pStream));
...
bool EventPipeStream::WriteEvent(EventPipeEventInstance &instance)
{
    CONTRACTL
    {
        THROWS;
...
void EventPipeStream::WriteToBlock(EventPipeEventInstance &instance, unsigned int metadataId)
{
    CONTRACTL
    {
        THROWS;
...
unsigned int EventPipeStream::GenerateMetadataId()
{
    CONTRACTL
    {
        NOTHROW;
...
unsigned int EventPipeStream::GetMetadataId(EventPipeEvent &event)
{
    CONTRACTL
    {
        NOTHROW;
...
void EventPipeStream::SaveMetadataId(EventPipeEvent &event, unsigned int metadataId)
{
    CONTRACTL
    {
        THROWS;
