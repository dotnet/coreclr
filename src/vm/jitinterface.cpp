                                           ...
                                           CORINFO_METHOD_INFO * methInfo)
{
    ...
    else if (tk == MscorlibBinder::GetMethod(METHOD__UNSAFE__BYREF_ARE_SAME)->GetMemberDef())
    {
        ...
        return true;
             ...
             tk == MscorlibBinder::GetMethod(METHOD__UNSAFE__PTR_INIT_BLOCK_UNALIGNED)->GetMemberDef())
    {
    ...
    else if (tk == MscorlibBinder::GetMethod(METHOD__UNSAFE__READ)->GetMemberDef())
    {
        mdToken tokGenericArg = FindGenericMethodArgTypeSpec(MscorlibBinder::GetModule()->GetMDImport());
    ...
    else if (tk == MscorlibBinder::GetMethod(METHOD__UNSAFE__COPY_BLOCK)->GetMemberDef())
    {
        static const BYTE ilcode[] = 
        {
            CEE_LDARG_0,
