...
DEFINE_METASIG(GM(PtrVoid_Byte_UInt_RetVoid, IMAGE_CEE_CS_CALLCONV_DEFAULT, 1, P(v) b K, v))
DEFINE_METASIG(GM(RefByte_Byte_UInt_RetVoid, IMAGE_CEE_CS_CALLCONV_DEFAULT, 1, r(b) b K, v))
