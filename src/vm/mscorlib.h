...
DEFINE_METHOD(RUNTIME_HELPERS,      FETCH_TAILCALL_ARG_BUFFER, FetchTailCallArgBuffer, SM_Int_RetIntPtr)
DEFINE_METHOD(RUNTIME_HELPERS,      RELEASE_TAILCALL_ARG_BUFFER, RELEASETailCallArgBuffer, SM_RetVoid)
