...
DEFINE_METHOD(UNSAFE,               PTR_INIT_BLOCK_UNALIGNED, InitBlockUnaligned, GM_PtrVoid_Byte_UInt_RetVoid)
DEFINE_METHOD(UNSAFE,               BYREF_INIT_BLOCK_UNALIGNED, InitBlockUnaligned, GM_RefByte_Byte_UInt_RetVoid)
DEFINE_METHOD(UNSAFE,               COPY_BLOCK,             CopyBlock, NoSig)
