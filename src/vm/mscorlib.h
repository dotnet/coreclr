...
DEFINE_FIELD_U(ResolvingUnmanagedDll,          AssemblyLoadContextBaseObject, _resovlingUnmanagedDll)
DEFINE_FIELD_U(Resolving,                      AssemblyLoadContextBaseObject, _resolving)
DEFINE_FIELD_U(Unloading,                      AssemblyLoadContextBaseObject, _unloading)
DEFINE_FIELD_U(<Name>k__BackingField,          AssemblyLoadContextBaseObject, _name)
...
DEFINE_FIELD_U(<IsCollectible>k__BackingField, AssemblyLoadContextBaseObject, _isCollectible)
