...
DEFINE_FIELD_U(_IL,                       MethodBody,         _IL)
DEFINE_FIELD_U(_exceptionHandlingClauses, MethodBody,         _exceptionClauses)
DEFINE_FIELD_U(_localVariables,           MethodBody,         _localVariables)
DEFINE_FIELD_U(_methodBase,               MethodBody,         _methodBase)
DEFINE_FIELD_U(_localSignatureMetadataToken, MethodBody,      _localVarSigToken)
DEFINE_FIELD_U(_maxStackSize,             MethodBody,         _maxStackSize)
DEFINE_FIELD_U(_initLocals,               MethodBody,         _initLocals)
