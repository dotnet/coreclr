...
// This method checks and returns whether there is sufficient stack to execute the average
// managed method. The limit for each thread is precomputed when the thread is created.
