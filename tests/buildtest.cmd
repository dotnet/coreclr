...
if /i "%1" == "gcstresslevel"       (set __GCStressLevel=%2&set processedArgs=!processedArgs! %1 %2&shift&shift&goto Arg_Loop)
if /i "%1" == "longgctests"         (set __LongGCTests=1&set processedArgs=!processedArgs! %1&shift&goto Arg_Loop)
if /i "%1" == "gcsimulator"         (set __GCSimulatorTests=1&set processedArgs=!processedArgs! %1&shift&goto Arg_Loop)
