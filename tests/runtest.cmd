...
if /i "%1" == "generatelayout"                          (set __GenerateLayout=1&shift&goto Arg_Loop)
...
if defined __GenerateLayout (
    set __RuntestPyArgs=%__RuntestPyArgs% --generate_layout
)

if defined __GenerateLayoutOnly (
    set __RuntestPyArgs=%__RuntestPyArgs% --generate_layout --generate_layout_only
)
...
echo generatelayout            - Generate the core root. This will overwrite the core root generated by build-test.cmd.
