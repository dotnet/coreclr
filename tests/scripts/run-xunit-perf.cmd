...
rem ****************************************************************************
  ...
  echo -slice-dir Specifies directory where slice<number>.txt files generated by run-xunit-slice.py can
  echo be found. To be used when you only want to run a subset of the perf test directories
