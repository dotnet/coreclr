...
namespace JIT.HardwareIntrinsics.Arm
{
    ...
    {
        private static void AbsScalarSingle()
        {
            var test = new SimpleUnaryOpTest__AbsScalarSingle();
    ...
    public sealed unsafe class SimpleUnaryOpTest__AbsScalarSingle
    {
        ...
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimpleUnaryOpTest__AbsScalarSingle testClass)
            {
            ...
            public void RunStructFldScenario_Load(SimpleUnaryOpTest__AbsScalarSingle testClass)
            {
        ...
        static SimpleUnaryOpTest__AbsScalarSingle()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data1[i] = -TestLibrary.Generator.GetSingle(); }
        ...
        public SimpleUnaryOpTest__AbsScalarSingle()
        {
            Succeeded = true;
