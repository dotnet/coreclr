...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void ConvertToInt32WithTruncationVector128Single()
        {
            var test = new SimdScalarUnaryOpConvertTest__ConvertToInt32WithTruncationVector128Single();
    ...
    public sealed unsafe class SimdScalarUnaryOpConvertTest__ConvertToInt32WithTruncationVector128Single
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimdScalarUnaryOpConvertTest__ConvertToInt32WithTruncationVector128Single testClass)
            {
                var result = Sse.ConvertToInt32WithTruncation(_fld);
        ...
        static SimdScalarUnaryOpConvertTest__ConvertToInt32WithTruncationVector128Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimdScalarUnaryOpConvertTest__ConvertToInt32WithTruncationVector128Single()
        {
            Succeeded = true;
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse.ConvertToInt32WithTruncation(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse).GetMethod(nameof(Sse.ConvertToInt32WithTruncation), new Type[] { typeof(Vector128<Single>) })
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Sse.ConvertToInt32WithTruncation(firstOp);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimdScalarUnaryOpConvertTest__ConvertToInt32WithTruncationVector128Single();
            var result = Sse.ConvertToInt32WithTruncation(test._fld);
        ...
        private void ValidateResult(Single[] firstOp, Int32 result, [CallerMemberName] string method = "")
        {
            ...
            if (!Succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Sse)}.{nameof(Sse.ConvertToInt32WithTruncation)}<Int32>(Vector128<Single>): {method} failed:");
