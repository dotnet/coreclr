...
namespace JIT.HardwareIntrinsics.X86
{
    ...
    {
        private static void ConvertToSingleVector128Single()
        {
            var test = new SimdScalarUnaryOpConvertTest__ConvertToSingleVector128Single();
    ...
    public sealed unsafe class SimdScalarUnaryOpConvertTest__ConvertToSingleVector128Single
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(SimdScalarUnaryOpConvertTest__ConvertToSingleVector128Single testClass)
            {
                var result = Sse.ConvertToSingle(_fld);
        ...
        static SimdScalarUnaryOpConvertTest__ConvertToSingleVector128Single()
        {
            for (var i = 0; i < Op1ElementCount; i++) { _data[i] = TestLibrary.Generator.GetSingle(); }
        ...
        public SimdScalarUnaryOpConvertTest__ConvertToSingleVector128Single()
        {
            Succeeded = true;
        ...
        public bool IsSupported => Sse.IsSupported && (Environment.Is64BitProcess || ((typeof(Single) != typeof(long)) && (typeof(Single) != typeof(ulong))));
        ...
        public void RunBasicScenario_UnsafeRead()
        {
            ...
            var result = Sse.ConvertToSingle(
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var result = typeof(Sse).GetMethod(nameof(Sse.ConvertToSingle), new Type[] { typeof(Vector128<Single>) })
                                     .Invoke(null, new object[] {
                                        Unsafe.Read<Vector128<Single>>(_dataTable.inArrayPtr)
                                     });

            ValidateResult(_dataTable.inArrayPtr, (Single)(result));
        }
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Sse.ConvertToSingle(firstOp);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new SimdScalarUnaryOpConvertTest__ConvertToSingleVector128Single();
            var result = Sse.ConvertToSingle(test._fld);
        ...
        private void ValidateResult(Vector128<Single> firstOp, Single result, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(void* firstOp, Single result, [CallerMemberName] string method = "")
        {
            Single[] inArray = new Single[Op1ElementCount];
        ...
        {
            if (BitConverter.SingleToInt32Bits(firstOp[0]) != BitConverter.SingleToInt32Bits(result))
            {
                Succeeded = false;
            }
            ...
            if (!Succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Sse)}.{nameof(Sse.ConvertToSingle)}<Single>(Vector128<Single>): {method} failed:");
