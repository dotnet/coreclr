...
namespace JIT.HardwareIntrinsics.X86
{
    public static partial class Program
    {
        ...
        {
            var test = new ScalarSimdUnaryOpConvTest__ConvertScalarToVector128Int32Int32();
    ...
    public sealed unsafe class ScalarSimdUnaryOpConvTest__ConvertScalarToVector128Int32Int32
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ScalarSimdUnaryOpConvTest__ConvertScalarToVector128Int32Int32 testClass)
            {
        ...
        static ScalarSimdUnaryOpConvTest__ConvertScalarToVector128Int32Int32()
        {
            _clsVar = TestLibrary.Generator.GetInt32();
        }

        public ScalarSimdUnaryOpConvTest__ConvertScalarToVector128Int32Int32()
        {
            Succeeded = true;
        ...
        private void ValidateResult(Int32 firstOp, Int32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!Succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Sse2)}.{nameof(Sse2.ConvertScalarToVector128Int32)}<Int32>): {method} failed:");
