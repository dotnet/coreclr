...
namespace JIT.HardwareIntrinsics.X86
{
    public static partial class Program
    {
        ...
        {
            var test = new ScalarSimdUnaryOpConvTest__ConvertScalarToVector128UInt32UInt32();
    ...
    public sealed unsafe class ScalarSimdUnaryOpConvTest__ConvertScalarToVector128UInt32UInt32
    {
        private struct TestStruct
        {
            ...
            public void RunStructFldScenario(ScalarSimdUnaryOpConvTest__ConvertScalarToVector128UInt32UInt32 testClass)
            {
        ...
        static ScalarSimdUnaryOpConvTest__ConvertScalarToVector128UInt32UInt32()
        {
            _clsVar = TestLibrary.Generator.GetUInt32();
        }

        public ScalarSimdUnaryOpConvTest__ConvertScalarToVector128UInt32UInt32()
        {
            Succeeded = true;
        ...
        private void ValidateResult(UInt32 firstOp, UInt32[] result, [CallerMemberName] string method = "")
        {
            ...
            if (!Succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Sse2)}.{nameof(Sse2.ConvertScalarToVector128UInt32)}<UInt32>): {method} failed:");
