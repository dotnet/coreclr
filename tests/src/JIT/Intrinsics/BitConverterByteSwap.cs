...
namespace BitConverterByteSwap
{
    class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            ushort swappedUInt16 = BitConverter.ByteSwap(ConstantUInt16Input);
            if (swappedUInt16 != ConstantUInt16Expected)
            {
                Console.WriteLine($"BitConverter.ByteSwap(const UInt16) failed.");
            ...
            ulong swappedUInt64 = BitConverter.ByteSwap(ConstantUInt64Input);
            ...
            ushort nonConstUInt16Output = BitConverter.ByteSwap(nonConstUInt16Input);
            ushort nonConstUInt16Expected = ByteSwapUInt16_Control(nonConstUInt16Input);
            if (nonConstUInt16Output != nonConstUInt16Expected)
            {
                Console.WriteLine($"BitConverter.ByteSwap(non-const UInt16) failed.");
            ...
            uint nonConstUInt32Output = BitConverter.ByteSwap(nonConstUInt32Input);
            uint nonConstUInt32Expected = ByteSwapUInt32_Control(nonConstUInt32Input);
            if (nonConstUInt32Output != nonConstUInt32Expected)
            {
                Console.WriteLine($"BitConverter.ByteSwap(non-const UInt32) failed.");
            ...
            ulong nonConstUInt64Output = BitConverter.ByteSwap(nonConstUInt64Input);
            ulong nonConstUInt64Expected = ByteSwapUInt64_Control(nonConstUInt64Input);
            if (nonConstUInt64Output != nonConstUInt64Expected)
            {
                Console.WriteLine($"BitConverter.ByteSwap(non-const UInt64) failed.");
