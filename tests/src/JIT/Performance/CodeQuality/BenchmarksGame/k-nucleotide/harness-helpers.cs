    ...
    class TestHarnessHelpers
    {
        ...
        public TestHarnessHelpers(bool bigInput, [System.Runtime.CompilerServices.CallerFilePath] string csFileName = "")
        {
            if (bigInput)
            {
                ...
                resourceName = $"{Path.GetFileNameWithoutExtension(csFileName)}.knucleotide-input-big.bin";
            }
            else
            {
                ...
                resourceName = $"{Path.GetFileNameWithoutExtension(csFileName)}.knucleotide-input.bin";
            }
