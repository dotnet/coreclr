    ...
    class TestHarnessHelpers
    {
        ...
        public TestHarnessHelpers(bool bigInput, [System.Runtime.CompilerServices.CallerFilePath] string csFileName = "")
        {
            if (bigInput)
            {
                ...
                resourceName = $"{Path.GetFileNameWithoutExtension(csFileName)}.revcomp-input25000.bin";
            }
            else
            {
                FileLength = 333;
                CheckSum = "62-45-8E-09-2E-89-A0-69-8C-17-F5-D8-C7-63-5B-50";
                resourceName = $"{Path.GetFileNameWithoutExtension(csFileName)}.revcomp-input25.bin";
            }
        }
