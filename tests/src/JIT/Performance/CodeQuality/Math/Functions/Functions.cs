...
namespace Functions
{
    public static class Program
    {
        ...
        private static readonly IDictionary<string, Action> TestList = new Dictionary<string, Action>() {
            ...
            ["acoshdouble"] = MathTests.AcoshDoubleTest,
            ["acoshsingle"] = MathTests.AcoshSingleTest,
            ["asindouble"] = MathTests.AsinDoubleTest,
            ["asinsingle"] = MathTests.AsinSingleTest,
            ["asinhdouble"] = MathTests.AsinhDoubleTest,
            ["asinhsingle"] = MathTests.AsinhSingleTest,
            ["atandouble"] = MathTests.AtanDoubleTest,
            ["atansingle"] = MathTests.AtanSingleTest,
            ["atanhdouble"] = MathTests.AtanhDoubleTest,
            ["atanhsingle"] = MathTests.AtanhSingleTest,
            ["atan2double"] = MathTests.Atan2DoubleTest,
            ["atan2single"] = MathTests.Atan2SingleTest,
            ["cbrtdouble"] = MathTests.CbrtDoubleTest,
            ["cbrtsingle"] = MathTests.CbrtSingleTest,
            ...
            ["fusedmultiplyadddouble"] = MathTests.FusedMultiplyAddDoubleTest,
            ["fusedmultiplyaddsingle"] = MathTests.FusedMultiplyAddSingleTest,
            ["ilogbdouble"] = MathTests.ILogBDoubleTest,
            ["ilogbsingle"] = MathTests.ILogBSingleTest,
            ["logdouble"] = MathTests.LogDoubleTest,
            ["logsingle"] = MathTests.LogSingleTest,
            ["log2double"] = MathTests.Log2DoubleTest,
            ["log2single"] = MathTests.Log2SingleTest,
            ...
            ["scalebdouble"] = MathTests.ScaleBDoubleTest,
            ["scalebsingle"] = MathTests.ScaleBSingleTest,
