...
namespace Functions
{
    public static partial class MathTests
    {
        ...
        private const int FusedMultiplyAddDoubleIterations = 40000;
        private const int ILogBDoubleIterations = 16000;
        private const int Log10DoubleIterations = 16000;
        private const int Log2DoubleIterations = 16000;
        ...
        private const int ScaleBDoubleIterations = 16000;
        ...
        private const int FusedMultiplyAddSingleIterations = 80000;
        private const int ILogBSingleIterations = 20000;
        private const int Log10SingleIterations = 20000;
        private const int Log2SingleIterations = 20000;
        ...
        private const int ScaleBSingleIterations = 20000;
