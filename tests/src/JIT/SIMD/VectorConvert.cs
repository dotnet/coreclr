...
partial class VectorTest
{
    ...
    static T getRandomValue<T>()
    {
        ...
        // Console.WriteLine("intValue is " + intValue + "; " + typeof(T) + " value is: " + value);
        return value;
    }
    ...
    static int Main()
    {
        ...
        Console.WriteLine("Testing Converts Between Single and Int32");
        for (int i = 0; i < 10; i++)
        {
        ...
        Console.WriteLine("Testing Converts Between Single and UInt32");
        for (int i = 0; i < 10; i++)
        {
            Vector<Single> singleVector = getRandomVector<Single>(singles);
        ...
        Console.WriteLine("Testing Converts between Double and Int64");
        for (int i = 0; i < 10; i++)
        {
        ...
        Console.WriteLine("Testing Converts between Double and UInt64");
        for (int i = 0; i < 10; i++)
        {
            Vector<Double> doubleVector = getRandomVector<Double>(doubles);
        ...
        Console.WriteLine("Testing Converts between Single and Double");
        for (int i = 0; i < 10; i++)
        {
        ...
        Console.WriteLine("Testing Converts between Int64 and Int32");
        for (int i = 0; i < 10; i++)
        {
        ...
        Console.WriteLine("Testing Converts between Int32 and Int16");
        for (int i = 0; i < 10; i++)
        {
        ...
        Console.WriteLine("Testing Converts between Int16 and SByte");
        for (int i = 0; i < 10; i++)
        {
        ...
        Console.WriteLine("Testing Converts between UInt64 and UInt32");
        for (int i = 0; i < 10; i++)
        {
        ...
        Console.WriteLine("Testing Converts between UInt32 and UInt16");
        for (int i = 0; i < 10; i++)
        {
        ...
        Console.WriteLine("Testing Converts between UInt16 and Byte");
        for (int i = 0; i < 10; i++)
        {
