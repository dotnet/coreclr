...
MCC_API VType3 __stdcall  sum(
		unsigned __int64 c1,	VType3 v1, 
		double c2,				VType3 v2,
		float c3,				VType3 v3,
		int c4,					VType3 v4,
		unsigned short c5,		VType3 v5,
		unsigned int c6,		VType3 v6,
		float c7,				VType3 v7,
		__int64 c8,				VType3 v8,
		float c9,				VType3 v9,
		double c10,				VType3 v10,
		float c11,				VType3 v11,
		short c12,				VType3 v12) {
