...
MCC_API VType5 __stdcall  sum(
    unsigned __int64 c1, VType5 v1,
    double c2, VType5 v2,
    float c3, VType5 v3,
    int c4, VType5 v4,
    unsigned short c5, VType5 v5,
    unsigned int c6, VType5 v6,
    float c7, VType5 v7,
    __int64 c8, VType5 v8,
    float c9, VType5 v9,
    double c10, VType5 v10,
    float c11, VType5 v11,
    short c12, VType5 v12) {
